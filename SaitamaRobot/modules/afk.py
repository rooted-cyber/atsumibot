...
def afk(update: Update, context: CallbackContext):
    ...
    if len(args) >= 2:
        ...
        if len(reason) > 100:
            reason = reason[:100]
            notice = "\nYour afk reason was shortened to 100 characters.Why the fk u want soo big AFK???"
    else:
        reason = ""
...
def no_longer_afk(update: Update, context: CallbackContext):
    ...
    if res:
        ...
        try:
            options = [
                'Welcome back you sucker {}','Everyone ready with guns? {} terrorist is here',
                'AA GYA NALLE WAPAS.... {}', '{} shitss...chutiya aa gya...', 'bsdk {}... why are you back😑',
                'the bawasir is back!!! {}'
            ]
