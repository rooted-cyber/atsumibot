![ATSUMI](https://telegra.ph/file/ac94ced0f931678788396.jpg)
# ATSUMI CHAN 
...
A biiiig thanks to [Kanako](https://t.me/perksofbeingkanako).... A modular Telegram Python bot running on python3 with a sqlalchemy database and an entirely themed persona to make ATSUMI suitable for Anime and Manga group chats. This is a fork of Saitama.

Can be found on telegram as [Atsumi-chan](https://t.me/atsumibot).

The Support group can be reached out to at [atsumi Support](https://t.me/atsumiSupport), where you can ask for help about [Atsumi](https://t.me/rash_sudo), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/rash-c9/atsumibot)
